...
# x = -85 ## base is at 90
# y = 150 ## original y coordinate position, change as needed
# z = -120 ## original z coordinate position, change as needed
# 
...
def on_press(key):
    ...
    if var == w: ## Moves meArm FORWARD when "w" key is pressed
        ...
        x = x - increment
        arm.gotoPoint(x,y,z)
    elif var == j: ## Moves meArm DOWN when "jj" key is pressed
        z = z + increment
        arm.gotoPoint(x,y,z)
    ...
    elif var == p: ## PARIALLY opens gripper, to percentage (inputed, default is 50% but this can be modified) of full open state when ";" key is pressed
